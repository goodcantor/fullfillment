...
keywords = [
    ...
    'упаковка', 'упакока', 'упаковак', 'упаквока', 'упакоавка', 'упакова',
    'упакока', 'упаковк', 'упаквка', 'упаковочка', 'упоковка', 'упакофка',
    'маркировка', 'маркеровка', 'маркирока', 'маркирова', 'маркирвока', 'маркировк',
    'маркеровка', 'маркировочка', 'маркеровочка', 'моркировка', 'маркровка', 'маркирока',
    'логистика', 'логситика', 'логиcтика', 'логистка', 'логистиа', 'логистиак',
    'логистика', 'логиситка', 'логстика', 'логисткиа', 'логисика', 'логистека',
    'доставка', 'досавка', 'достава', 'достаква', 'доставк', 'доставкаа',
    'достака', 'доствка', 'достовка', 'досатвка', 'доставкка', 'досавка'
]
